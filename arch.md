# AIxCTF Architecture Index

`arch.md` has been split into focused documents under `docs/architecture/`.
...
- [Diagrams](docs/architecture/diagrams/README.md)

The current monolithic handoff is maintained at [docs/architecture/full-handoff-v1.md](docs/architecture/full-handoff-v1.md).
